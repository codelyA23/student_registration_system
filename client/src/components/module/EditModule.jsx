...
const EditModule = () => {
    ...
    const [UpdatedBy, setUpdatedByy] = useState(`${updatedBy}`);
        ...
        const getModuleById = async () => {
            try {
                ...
                const response = await axios.get(
                    `http://localhost:2402/moduleById/${module_id}`,
                    config
                );

                setModule_name(response.data.course_code);
                setDescription(response.data.course_name);
                setStart_date(response.data.description);
                setEnd_date(response.data.credits);
    ...
    const updateModule = async (e) => {
        ...
        try {
            await axios.patch(
                `http://localhost:2402/modulesUpdate/${module_id}`,
                {
                    module_name,
                    course_id,
                    description,
                            ...
                            <div className="field" hidden>
                                ...
                                <CInputGroup className="mb-4">
                                    <CFormInput
                                        ...
                                        className="input"
                                        value={updatedBy}
                                        onChange={(e) => setUpdatedByy(e.target.value)}
