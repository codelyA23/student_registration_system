...
const EditFaculty = () => {
    ...
    const getCourseById = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:2402/facultysById/${faculty_id}`,
          config
        );
        setDepartment(response.data.department,);
        setOffice_number(response.data.office_number,);
  ...
  const updateFaculty = async (e) => {
    ...
    try {
      await axios.patch(
        `http://localhost:2402/facultyUpdate/${faculty_id}`,
        {
          user_id,
          department,
          office_number,
            ...
            <form onSubmit={updateFaculty}>
              ...
              <div className="field">
                <div className="control">
                  ...
                  >
                    <span><MdPersonAddAlt1 /></span> {''} Save Faculty
                  </button>
                </div>
              </div>
            </form>
